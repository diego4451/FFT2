...
do_compile () {
	nasm -f elf64 fftfullensam.asm -o fftfullensam.o
	gcc -no-pie fftfullensam.o -o fftfullensam -lm
}

do_install () {
	install -d ${D}${bindir}
	install -m 0755 fftfullensam ${D}${bindir}
}
